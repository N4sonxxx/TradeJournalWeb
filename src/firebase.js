...
import { getStorage } from "firebase/storage"; // 1. Tambahkan impor ini
...
const firebaseConfig = {
  ...
  storageBucket: "jurnal-trading-saya.appspot.com", // Pastikan ini benar
...
export const storage = getStorage(app); // 2. Tambahkan ekspor ini
